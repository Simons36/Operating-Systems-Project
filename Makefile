...
HEADERS  := $(wildcard */*.h)
OBJECTS  := $(SOURCES:.c=.o)
TARGET_EXECS := fs/tfs_server tests/correia_test tests/lib_destroy_after_all_closed_test tests/my_client_test tests/my_client_test2 tests/client_server_simple_test
...
tests/my_client_test: tests/my_client_test.o client/tecnicofs_client_api.o
tests/my_client_test2: tests/my_client_test2.o client/tecnicofs_client_api.o
tests/correia_test: tests/correia_test.o client/tecnicofs_client_api.o
